...
from app.semantic_retrieval.products import index_products  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Indexa embeddings semanticos de productos para un tenant.")
    ...
    db = Session()
    try:
        stats = index_products(db, company_id=tenant.company_id, model=args.model, batch_size=args.batch_size)
