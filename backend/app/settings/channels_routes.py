...
CHANNEL_CONFIG_SPECS = {
    ...
    "whatsapp": {
        ...
        "fields": [{"key": "business_name", "label": "Nombre visible"}, {"key": "phone_number", "label": "Número de teléfono"}, {"key": "provider", "label": "Proveedor"}, {"key": "access_token", "label": "Token de acceso", "secret": True}, {"key": "webhook_secret", "label": "Secreto webhook", "secret": True}],
        "required_keys": ["phone_number", "access_token"],
    },
    "voice": {
